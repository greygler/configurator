...
<fieldset>
  ...
  <fieldset>
    <legend><h2>Интеграция с Dropplatforma.ru: </h2></legend>
	<label for="product_id">ID продукта: <em>*</em></label><input required id="product_id" type="text" name="product_id" value="<?=  $product_id ?>" placeholder="ID продукта"></p>
	<label for="key">Ключ:  <em>*</em></label><input required id="key" type="text" name="key" value="<?= $key; ?>" placeholder="Уникальный ключ"></p>
